...
pub fn rks_kxc_pot_with_output(
    ...
    for i2 in 0..nset2 {
        for i1 in 0..nset1 {
            ...
            contract_ao_wv_without_buf(den_type, kxc_contracted.view(), ao.view(), kxc.i_mut((.., .., i1, i2)), buf)?;
        }
    }
    Ok(())
}
...
pub fn uks_vxc_pot_with_output(
    ...
    for s in 0..2 {
        ...
        contract_ao_wv_without_buf(den_type, vxc_contracted.view(), ao.view(), vxc.i_mut((.., .., s)), buf)?;
    }
    Ok(())
}
...
pub fn uks_fxc_pot_with_output(
    ...
    for i in 0..nset {
        for s in 0..2 {
            ...
            contract_ao_wv_without_buf(den_type, fxc_contracted.view(), ao.view(), fxc.i_mut((.., .., s, i)), buf)?;
        }
    }
    Ok(())
}
