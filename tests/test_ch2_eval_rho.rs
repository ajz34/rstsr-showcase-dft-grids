...
mod test_eval_rho_pure {
    ...
    fn test_get_rho_from_one_bra_mult_ket_naive_vs_optimized(ch2: &Ch2Molecule) {
        ...
        for den_type in [RHO, SIGMA, TAU, LAPL] {
            ...
            .unwrap();
            get_rho_from_one_bra_mult_ket_with_output(ao.view(), bra.view(), &ket_views, den_type, out_opt.view_mut(), ni_obj.nchunk)
                .unwrap();
    ...
    fn test_get_rho_from_mult_bra_mult_ket_naive_vs_optimized(ch2: &Ch2Molecule) {
        ...
        for den_type in [RHO, SIGMA, TAU, LAPL] {
            ...
            .unwrap();
            get_rho_from_mult_bra_mult_ket_with_output(ao.view(), &bra_views, &ket_views, den_type, out_opt.view_mut(), ni_obj.nchunk)
                .unwrap();
